...
export default function ServicesSectionStableVersion() {
    ...
    return (
        <section className="relative bg-white">
            {/* Section Header */}
            <div className="bg-[#EAEAF2] text-center p-8 rounded-b-3xl shadow-[0_10px_20px_-4px_rgba(0,0,0,0.3)] px-52">
                <h2 className="text-4xl font-bold text-[#373A5C] leading-snug">
